                        ...
                        <div class="card card-animate">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-end justify-content-between mt-4">
                                    <div>
                                        <h4 class="fs-22 fw-semibold ff-secondary mb-4">{{ $countAppointmentRequests }}
                                        </h4>
                                    </div>
                    ...
                    <div class="col-xl-3 col-md-6">
                        ...
                        <div class="card card-animate">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-end justify-content-between mt-4">
                                    <div>
                                        <h4 class="fs-22 fw-semibold ff-secondary mb-4">{{ $countServices }}</h4>
                                    </div> 
                                    <div class="avatar-sm flex-shrink-0">
                    ...
                    <div class="col-xl-3 col-md-6">
                        ...
                        <div class="card card-animate">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-end justify-content-between mt-4">
                                    <div>
                                        <h4 class="fs-22 fw-semibold ff-secondary mb-4">${{ getWithdrawnBalance() }}
                                        </h4>
                                    </div>
                                    <div class="avatar-sm flex-shrink-0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            {{-- <div class="hstack gap-3 flex-wrap">
                                                                @isset($appointment->collectionDetails)
                                                                    <button class = "btn btn-primary make-appointment-button"
                                                                        data-bs-toggle="modal"
                                                                        data-bs-target=".bs-modal-make-appointment"
                                                                        onclick  = "getTransactionId({{ $appointment->id }},{{ $appointment->serviceDetails->price }})">Withdraw</button>
                                                                @endisset
                                                            </div> --}}
                                                            <div class="hstack gap-3 flex-wrap">
                                                                <a href="{{ route('vendor.appointmentDetails', ['id' => $appointment->id, 'user_id' => $appointment->user->id]) }}"
