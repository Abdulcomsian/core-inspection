...
{{-- @if ($get == 'users' && !!$lastMessage)
    ...
    ?>
    <table class="messenger-list-item" data-contact="{{ $user->id }}" onclick="openChat('{{ $user->id }}')">
        <tr data-action="0">
            <td style="position: relative">
                ...
                <div class="avatar av-m"
                    style="background-image: url('{{ $filename && $filename !== 'users-avatar' ? asset('images/' . $filename) : URL::asset('build/images/users/avatar-1.jpg') }}');">
                </div>
