            ...
            <div class="toolbar d-flex flex-stack">
                <div class="page-title d-flex align-items-center me-3 flex-wrap mb-5 mb-lg-0 lh-1">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <li class="breadcrumb-item text-muted">Equipment Types</li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="container-fluid">
                    <div class="mt-3">
                        <div class="d-flex mb-3">
                            <a href="{{ route('configuration.equipment_type.create') }}">
                            <button type="button" class="btn btn-primary me-3"><i class="fas fa-plus"></i>
                                Add New
                            </button>
                        </a>
                            <button type="button" class="btn btn-primary me-3" data-bs-toggle="modal"
                                data-bs-target="#kt_modal_add_user"><i class="fas fa-search"></i>
                                Search
                            </button>
                        </div>
