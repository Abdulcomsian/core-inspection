                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="form-group mt-3">
                                            <button type="button" class="btn btn-sm" style="background-color: #7F8C8D">Anchor Point</button>
                                            <button type="button" class="btn btn-sm" style="background-color: #E67E22">Permanent Safety Line</button>
                                        </div>
                                    </div>
                                </div>
