                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="form-group mt-3">
                                            <button type="button" class="btn btn-sm" style="background-color: #7F8C8D;color: #fff;">Anchor Point</button>
                                            <button type="button" class="btn btn-sm" style="background-color: #E67E22;color: #fff;">Permanent Safety Line</button>
                                        </div>
                                    </div>
                                </div>
