            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive table-card">
                        <table class="table table-centered align-middle table-nowrap mb-0" id="admin-appointments-table">
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            var table = $('#admin-appointments-table').DataTable({
                processing: true,
                serverSide: true,
                lengthChange: true,
                searching: true,
            ...
            $('#admin-appointments-table_filter').hide();
            // $('#appointments-table_filter').css({
            //     'width': '33.33%',
            //     'float': 'left'
            // });

            $('#admin-appointments-table_filter').after(`
