                                        ...
                                        <tbody>
                                            @isset($unapprovedVendors)
                                                @foreach ($unapprovedVendors as $index => $unapprovedVendor)
                                                    <tr>
                                                        <td>{{ $index + 1 }}</td>
                                                        <td>{{ $unapprovedVendor->first_name }}</td>
                                                        <td>{{ $unapprovedVendor->last_name }}</td>
                                                        <td>{{ $unapprovedVendor->email }}</td>
                                                        <td>Service Provider</td>
                                                        @if ($unapprovedVendor->is_approved == 0)
                                                            <td><span class="badge bg-warning text-dark">Pending</span></td>
                                                        @elseif($unapprovedVendor->is_approved == 2)
                                                        ...
                                                        <td>
                                                            <div class="hstack gap-3 flex-wrap">
                                                                <a href="{{ url('admin/service-provider-detail', $unapprovedVendor->id) }}"
