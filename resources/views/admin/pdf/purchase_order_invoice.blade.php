        ...
        <div class="body">
            <div class="row">
                <div class="col-6">
                    ...
                    <span>{{ $addStock->date }}</span>
                </div>
                <div class="col-6">
                    <span class="bold">Supplier:</span>
                    <span>{{ $addStock->supplier->name }}</span>
                </div>
                <div class="col-6">
                    <span class="bold">Stock Number:</span>
                    <span>{{ $addStock->stock_number }}</span>
                </div>
                <div class="col-6">
                    <span class="bold">Pay Type:</span>
                    <span>{{ $addStock->pay_type }}</span>
                </div>
            </div>
            <hr>

            <table class="item-table" style="width: 100%; table-layout: fixed;">
                <tr>
                    <th>Sr</th>
                    <th>Product</th>
                ...
                @foreach ($addStock->addStockLogs as $key => $stockLogs)
                    <tr>
                        <td>{{ $key + 1 }}</td>
                        <td style="word-wrap: break-word;">{{ $stockLogs->product->name ?? '' }}</td>
                        <td style="word-wrap: break-word;">{{ $stockLogs->product->category->name ?? '' }}</td>
            ...
            <table class="" style="width: 100%;font-size:12px">
                <tr>
                    ...
                    <td class="currency" style="width: 50%;">{{ numberFormat($addStock->total_bill) }}</td>
                </tr>
                <tr>
                    <td class="text-left" style="width: 35%;">Total Paid:</td>
                    <td style="width: 15%;">Rp.</td>
                    <td class="currency" style="width: 50%;">{{ numberFormat($addStock->total_paid) }}</td>
                </tr>
                <tr>
                    <td class="text-left" style="width: 35%;">Remaining:</td>
                    <td style="width: 15%;">Rp.</td>
                    <td class="currency" style="width: 50%;">{{ numberFormat($addStock->total_bill - $addStock->total_paid) }}
                    </td>
                </tr>
            </table>
